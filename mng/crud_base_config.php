...
$crud_base_path = dirname(dirname(__FILE__)) . '/CrudBase/php/CrudBase/';
define('CRUD_BASE_PATH', $crud_base_path);


$crud_base_project_path = '/mng'; // 例：「/animal/mng」
if(strpos($_SERVER['SERVER_NAME'], 'localhost') !== false){
    $crud_base_project_path = '/coralpaint/mng';
}
...
$crud_base_js = "/CrudBase/js/CrudBase/dist/CrudBase.min.js?v=" . CRUD_BASE_VERSION;
$crud_base_css = "/CrudBase/css/CrudBase/dist/CrudBase.min.css?v=" . CRUD_BASE_VERSION;

if(strpos($_SERVER['SERVER_NAME'], 'localhost') !== false){
    $crud_base_js = "/coralpaint/" . $crud_base_js;
    $crud_base_css = "/coralpaint/" . $crud_base_css;
}
