...
<head>
	...
	<script src="{{ asset('/js/Img/index.js')  . $ver_str }}" defer></script>
...
<div class="cb_func_line">
	...
	<!-- 検索条件入力フォーム -->
	<form action="" class="form_kjs" id="imgIndexForm" method="post" accept-charset="utf-8">
		
		<?php $this->CrudBase->inputKjMain('kj_main','',null,'画像名、備考を検索する');?>
...
<!-- 一覧テーブル -->
<table id="img_tbl" class="table table-striped table-bordered table-condensed" style="display:none;margin-bottom:0px">
