 ...
 * @license MIT
 * @author k-uehara 
 */var ClmShowHide=function(){var t=this;function e(e,i,a){var r=jQuery("#"+t.props.chBoxsId);for(var n in t.defClmData){var s=t.defClmData[n].show_flg,l=r.find("[index="+n+"]");l[0]&&(1==s?(l.prop("checked",!0),t.clm_show_csh(e,n)):0==s&&(l.prop("checked",!1),t.clm_hide_csh(e,n)))}localStorage.removeItem(a+"_clmData")}function i(){var e=jQuery("#"+t.props.chBoxsId),i=t.actClmData;for(var a in i){var r=e.find("[index="+a+"]");if(r[0]){var n=r.prop("checked");i[a].show_flg=1==n?1:0}}return i}this.props={},this.defClmData={},this.actClmData={},this.init=function(a,r,n,s){this.props.tblId=a,this.props.chBoxsId=r,this.props.unique=s,null==s&&(s=a);for(var l=[],o=0;o<n.length;o++){var h={clm_name:null,show_flg:n[o]};l[o]=h}o=0;$.each(jQuery("#"+a+" thead tr th"),(function(){var t=jQuery(this).html();try{l[o].clm_name=t}catch(t){return}o++}));var d=localStorage.getItem(s+"_clmData"),_={};for(var o in _=""==d||null==d?$.extend(!0,{},l):JSON.parse(d),this.defClmData=l,this.actClmData=_,_=function(t){for(let e in t){let i=t[e],a=i.clm_name;null==a&&(a=""),i.clm_name=a.replace(/<("[^"]*"|'[^']*'|[^'">])*>/g,"")}return t}(_),function(t,e,i){var a=jQuery("#"+e);for(var r in a.empty(),i){var n=i[r];if(-1==n.show_flg)continue;var s="";1==n.show_flg&&(s="checked");let t="csh_cb"+r;var l="<div class='csh_cb_div'><input id='"+t+"' type='checkbox' class='csh_cb' "+s+" index='"+r+"' /><label for='"+t+"'>"+n.clm_name+"</label></div>";a.append(l)}a.append("<div style='clear:both'></div>");var o="<div class='csh_func_btn'><input type='button' value='列表示を保存' id='"+t+"_save_btn' class='btn btn-primary btn-sm' /></div>";a.append(o);var h="<div class='csh_func_btn'><input type='button' value='すべてチェック' id='"+t+"_all_checked_btn' class='btn btn-primary btn-sm' /></div>";a.append(h);var d="<div class='csh_func_btn'><input type='button' value='すべてはずす' id='"+t+"_all_uncheck_btn' class='btn btn-primary btn-sm' /></div>";a.append(d);var _="<div class='csh_func_btn'><input type='button' value='初期に戻す' id='"+t+"_default_btn' class='btn btn-primary btn-sm' /></div>";a.append(_),a.append("<div id='csh_msg' class='csh_func_btn' style='display:none;color:#de5246'>列の表示状態を記憶しました。</div>")}(a,r,_),jQuery(".csh_cb").click((function(e){var i=jQuery(this).prop("checked"),r=jQuery(this).attr("index");1==i?t.clm_show_csh(a,r):t.clm_hide_csh(a,r)})),_){0==(h=_[o]).show_flg&&this.clm_hide_csh(a,o)}jQuery("#"+a+"_save_btn").click((function(t){!function(t,e,a){var r=i(),n=JSON.stringify(r);localStorage.setItem(a+"_clmData",n),jQuery("#csh_msg").show(),jQuery("#csh_msg").fadeOut(3e3)}(0,0,s)})),jQuery("#"+a+"_all_checked_btn").click((function(e){!function(e,i,a){var r=jQuery("#"+t.props.chBoxsId);for(var n in a){var s=r.find("[index="+n+"]");if(s[0])0==s.prop("checked")&&(s.prop("checked",!0),t.clm_show_csh(e,n))}}(a,0,t.actClmData)})),jQuery("#"+a+"_all_uncheck_btn").click((function(e){!function(e,i,a){var r=jQuery("#"+t.props.chBoxsId);for(var n in a){var s=r.find("[index="+n+"]");if(s[0])1==s.prop("checked")&&(s.prop("checked",!1),t.clm_hide_csh(e,n))}}(a,0,t.actClmData)})),jQuery("#"+a+"_default_btn").click((function(t){e(a,r,s)}))},this.getCshAry=function(){var e=jQuery("#"+t.props.chBoxsId),i=[];for(var a in this.defClmData){var r=e.find("[index="+a+"]");if(r[0])1==r.prop("checked")?i.push(1):i.push(0)}return i},this.reset=function(){e(this.props.tblId,this.props.chBoxsId,this.props.unique)},this.refresh=function(){var t=this.props.tblId;for(var e in this.defClmData)this.clm_show_csh(t,e);var a=i();for(var e in a){var r=a[e].show_flg;1==r?this.clm_show_csh(t,e):0==r&&this.clm_hide_csh(t,e)}},this.clm_show_csh=function(t,e){jQuery("#"+t+" thead tr th").eq(e).show(),$.each(jQuery("#"+t+" tbody tr"),(function(){jQuery(this).children().eq(e).show()}))},this.clm_hide_csh=function(t,e){jQuery("#"+t+" thead tr th").eq(e).hide(),$.each(jQuery("#"+t+" tbody tr"),(function(){jQuery(this).children().eq(e).hide()}))}};
/**
